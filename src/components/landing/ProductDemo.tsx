...
export default async function ProductDemo() {
  ...
  return (
    <>
      <section id="produit" className="section1" data-screen-label="Section 1 — Démo produit" style={{ scrollMarginTop: '84px' }}>
        <div className="section1__inner">
          <div className="section1__anchor">
            <p className="section1__eyebrow"><span className="section1__pip"></span>{t("eyebrow")}</p>
            <h2 className="section1__h2">{t("h2")}</h2>
            <p className="section1__sub">
              {t("subLine")}
              <strong>{t("subStrong")}</strong>
            </p>
            <div className="section1__pills">
              <span className="section1__pill">{t("pillCommande")}</span><span className="section1__arrow">→</span>
              <span className="section1__pill">{t("pillQr")}</span><span className="section1__arrow">→</span>
              <span className="section1__pill section1__pill--pivot">{t("pillScan")}</span><span className="section1__arrow">→</span>
              <span className="section1__pill">{t("pillSuivi")}</span>
            </div>
          </div>
                ...
                <div className="section1__screen">
                  ...
                  <div className="s1-scr">
                    <div className="s1-dash">
                      <p className="s1-dash__hi">{t("dashHi")}</p>
                      <p className="s1-dash__name">{t("dashName")}</p>
                      <p className="s1-dash__sub">{t("dashSub")}</p>
                    ...
                    <div className="s1-statGrid">
                      <div className="s1-stat">
                        ...
                        <div className="s1-stat__lbl">{t("statCommandes")}</div>
                        <div className="s1-stat__num">38</div>
                        <div className="s1-stat__delta s1-em">{t("statCommandesDelta")}</div>
                      </div>
                      <div className="s1-stat">
                        ...
                        <div className="s1-stat__lbl">{t("statPending")}</div>
                        <div className="s1-stat__num">7</div>
                        <div className="s1-stat__delta s1-am">{t("statPendingDelta")}</div>
                      </div>
                      <div className="s1-stat">
                        ...
                        <div className="s1-stat__lbl">{t("statDelivered")}</div>
                        <div className="s1-stat__num">17</div>
                        <div className="s1-stat__delta s1-md">{t("statDeliveredDelta")}</div>
                      </div>
                      <div className="s1-stat s1-stat--glow">
                        ...
                        <div className="s1-stat__lbl">{t("statCa")}</div>
                        <div className="s1-stat__num">4 750 DA</div>
                        <div className="s1-stat__delta s1-em">{t("statCaDelta")}</div>
                      </div>
                    </div>
                    <div className="s1-listHead">
                      <span className="s1-listHead__t">{t("listHead")}</span>
                      <span className="s1-listHead__all">{t("listAll")}</span>
                    </div>
                    <div className="s1-ord">
                      ...
                      <div className="s1-ord__right"><div className="s1-ord__amt">4 750 DA</div><div className="s1-ord__st"><span className="dot" style={{ background: 'var(--s1-ambre)' }}></span>{t("statusPending")}</div></div>
                    </div>
                    <div className="s1-ord">
                      ...
                      <div className="s1-ord__right"><div className="s1-ord__amt">2 200 DA</div><div className="s1-ord__st"><span className="dot" style={{ background: 'var(--s1-mist-dim)' }}></span>{t("statusProcessing")}</div></div>
                    </div>
                    <div className="s1-ord">
                      ...
                      <div className="s1-ord__right"><div className="s1-ord__amt">2 200 DA</div><div className="s1-ord__st"><span className="dot" style={{ background: 'var(--s1-accent)' }}></span>{t("statusDelivered")}</div></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="section1__phone section1__phone--center">
                <div className="section1__screen">
                  ...
                  <div className="s1-scr">
                    ...
                    <div className="s1-detStatus"><span className="s1-detStatus__lbl"><span className="dot"></span>{t("detStatusShipped")}</span><span className="s1-detStatus__chg">{t("detStatusChange")}</span></div>
                    <div className="s1-detBlock">
                      <div className="s1-detBlock__sec">{t("detInfos")}</div>
                      <div className="s1-detRow"><span className="k">{t("detRef")}</span><span className="v">LV-2605-8429</span></div>
                      <div className="s1-detRow"><span className="k">{t("detDate")}</span><span className="v">29/05/2026 22:49</span></div>
                    </div>
                    <div className="s1-detBlock">
                      <div className="s1-detBlock__sec">{t("detArticles")}</div>
                      ...
                      <div className="s1-detRow"><span className="k">{t("detSubtotal")}</span><span className="v">4 400 DA</span></div>
                      <div className="s1-detRow"><span className="k">{t("detDelivery")}</span><span className="v">350 DA</span></div>
                      <div className="s1-detSep"></div>
                      <div className="s1-detTot"><span className="k">{t("detTotal")}</span><span className="v">4 750 DA</span></div>
                    </div>
                    <div className="s1-detBlock">
                      <div className="s1-detBlock__sec">{t("detActions")}</div>
                      <div className="s1-qrWrap">
                        ...
                        <span className="s1-qrCap">{t("qrCaption")}</span>
                      </div>
                      <div className="s1-wa">
                    ...
                    <div className="s1-map">
                      ...
                      <div className="s1-sheet">
                        <div className="s1-sheet__row">
                          ...
                          <span className="s1-sheet__badge">{t("sheetBadge")}</span>
                        </div>
        ...
        <p className="section1__caption">{t("caption")}</p>
