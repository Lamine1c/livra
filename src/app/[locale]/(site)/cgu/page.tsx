      ...
      <main>
        <article style={{ maxWidth: "48rem", margin: "0 auto", padding: "6rem 1.5rem" }}>
          ...
          <div style={sectionBody}>
            ...
            <p style={bodyText}>{"6.3. Plan Fondateur — clause de gel tarifaire. Le tarif Fondateur de 499 DA est garanti à vie pour le Vendeur tant que son abonnement reste actif sans interruption de paiement. Ce tarif couvre les fonctionnalités du Plan Fondateur telles qu'elles existent à la date de souscription, ainsi que leurs corrections et améliorations. Les nouvelles fonctionnalités majeures introduites ultérieurement par LIVRA (notamment dans des plans supérieurs type Pro, Business ou Enterprise) ne sont PAS automatiquement incluses dans le Plan Fondateur et peuvent faire l'objet d'options payantes distinctes. Le Vendeur perd définitivement le bénéfice du tarif Fondateur en cas d'interruption de son abonnement supérieure à trente (30) jours consécutifs (par annulation, ou par non-paiement non régularisé pendant plus de trente jours) ; il devra alors souscrire au tarif Standard en vigueur s'il souhaite revenir. En revanche, un simple échec de prélèvement isolé ne fait PAS perdre le tarif Fondateur tant qu'une relance de paiement est en cours et que l'interruption effective ne dépasse pas trente (30) jours : dans ce cas, la régularisation du paiement rétablit l'abonnement sans perte du tarif Fondateur."}</p>
