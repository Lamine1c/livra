...
export async function POST(req: NextRequest) {
  ...
  if (delErr) {
    console.error("[complete-delivery] deliveries update failed:", delErr.message);
  ...
  if (ordErr) {
    console.error("[complete-delivery] orders update failed after delivery completed:", ordErr.message);
    return NextResponse.json(
