      ...
      <section className="section4" data-screen-label="Section 4 — OTP anti fausses commandes">
        <div className="section4__inner">
          <header className="section4__header">
            <p className="s4-eyebrow s4-rise"><span className="s4-pip"></span>{t("eyebrow")}</p>
            <h2 className="s4-title s4-rise">{t("title_before")}<em>{t("title_em")}</em>{t("title_after")}</h2>
            <p className="s4-sub s4-rise">
              {t("sub_line1")}
              <strong>{t("sub_strong")}</strong>{t("sub_line2")}
            </p>
            <div className="s4-flow s4-rise">
              <span className="s4-step">{t("flow_step1")}</span><span className="s4-arr">→</span>
              <span className="s4-step">{t("flow_step2")}</span><span className="s4-arr">→</span>
              <span className="s4-step pivot">{t("flow_step3")}</span><span className="s4-arr">→</span>
              <span className="s4-step">{t("flow_step4")}</span>
            </div>
          </header>
            ...
            <div className="s4-tri">
              ...
              <div className="s4-phone s4-phone-side s4-phone-l s4-float-a">
                <div className="s4-screen">
                  ...
                  <div className="s4-scr">
                    <div className="s4-det-bar"><span className="back">‹</span><span className="ref">{t("m1_ref")}</span></div>
                    <div className="s4-det-status">
                      <span className="lbl"><span className="dot"></span>{t("m1_status")}</span>
                      <span className="s4-pill-wait">{t("m1_pill")}</span>
                    </div>
                    <div className="s4-det-block">
                      <div className="sec">{t("m1_client_sec")}</div>
                      <div className="s4-det-row"><span className="k">{t("m1_client_name_k")}</span><span className="v">{t("m1_client_name_v")}</span></div>
                      <div className="s4-det-row"><span className="k">{t("m1_client_phone_k")}</span><span className="v">{t("m1_client_phone_v")}</span></div>
                    </div>
                    <div className="s4-det-block">
                      <div className="sec">{t("m1_articles_sec")}</div>
                      <div className="s4-det-art"><span className="nm">{t("m1_article_name")}</span><span className="calc">{t("m1_article_price")}</span></div>
                    </div>
                    <div className="s4-actions">
                      <div className="sec">{t("m1_actions_sec")}</div>
                      ...
                      <p className="s4-cta-sub">{t("m1_cta_sub")}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="s4-screen s4-client">
                  ...
                  <div className="s4-scr" style={{ paddingTop: '50px' }}>
                    ...
                    <div className="s4-wa-body">
                      <span className="s4-day">{t("m2_day")}</span>
                      <div className="s4-bubble recv">
                        ...
                        <p className="msg" dir="auto">{t("m2_msg2")}</p>
                        <div className="s4-meta"><span className="time">{t("m2_time1")}</span></div>
                      </div>
                      <div className="s4-bubble sent">
                        <p className="msg"><span className="big-code">{t("m2_code_reply")}</span></p>
                        <div className="s4-meta">
                          <span className="time">{t("m2_time2")}</span>
                          <span className="rd">
                      ...
                      <div className="s4-bubble recv">
                        <p className="msg" dir="auto">{t("m2_msg3")}</p>
                        <div className="s4-meta"><span className="time">{t("m2_time3")}</span></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="s4-phone s4-phone-side s4-phone-r s4-float-b">
                <div className="s4-screen">
                  ...
                  <div className="s4-statusbar"><span>9:41</span><SbLight /></div>
                  <div className="s4-scr">
                    <div className="s4-det-bar"><span className="back">‹</span><span className="ref">{t("m3_ref")}</span></div>
                    <div className="s4-det-status">
                      <span className="lbl"><span className="dot" style={{ background: 'var(--emerald-lt)', boxShadow: '0 0 8px 1px rgba(52,211,153,0.5)' }}></span>{t("m3_status")}</span>
                    ...
                    <div className="s4-banner">
                      ...
                      <span className="tt">{t("m3_banner_title")}<br /><span>{t("m3_banner_time")}</span></span>
                    </div>
                    <div className="s4-det-block">
                      <div className="sec">{t("m3_articles_sec")}</div>
                      <div className="s4-det-art"><span className="nm">{t("m3_article_name")}</span><span className="calc">{t("m3_article_price")}</span></div>
                    </div>
                    <div className="s4-actions">
                      <div className="sec">{t("m3_actions_sec")}</div>
                      ...
                      <p className="s4-cta-sub">{t("m3_cta_sub")}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <p className="s4-caption">{t("caption")}</p>
