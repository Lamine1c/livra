...
cat > src/components/orders/tracking-timeline.tsx << 'EOF'
"use client";
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: 32, flexShrink: 0 }}>
              ...
              <div
                style={{
                  ...
                  border: isActive ? `2px solid ${EMERALD}` : isDone ? `2px solid rgba(16,185,129,0.4)` : "2px solid rgba(245,240,232,0.1)",
              ...
              {!isLast && (
                <div
                  style={{
                    ...
                    flex: 1,
                    minHeight: 24,
                    background: isDone ? EMERALD : "rgba(245,240,232,0.08)",
                    margin: "4px 0",
                  }}
                />
              )}
